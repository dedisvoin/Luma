...
class ExpressionVariableGet:
    ...
    def eval(self):
        ...
        if self.__memory.ContainWithNameObject(self.__var_name):
            ...
            luma_exceptions.VariableNotFound(self.__file_name, self.__pos, self.__var_name)
...
class ExpressionFunObject:
    def __init__(self, arguments: list[str], expression, file_name: str) -> None:
        self.__arguments = arguments
        self.__expression = expression
        self.__file_name = file_name
    ...
    def eval(self):
        return luma_values.FunctionValue.Create(
            luma_functions.LumaFunction.ConstructLumaFunction(
                self.__expression, None, True, self.__file_name, self.__arguments
            )
        )
