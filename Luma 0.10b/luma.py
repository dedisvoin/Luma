...
class LumaInterpretator:
    ...
    def load_from_code(self, code, file_name: str):
        self.tokenizer.load_string(code)
...
if __name__ == '__main__':
    ...
    comp = LumaInterpretator(arg_wrapper.debug_level, arg_wrapper.create_bin_file)
